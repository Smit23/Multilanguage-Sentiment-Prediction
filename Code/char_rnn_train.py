...
if __name__ == '__main__':
	...
	model = RNN(deepcopy(X_train),deepcopy(y_train),[MAX_FEATURES, MAXLEN, embedding_size,filter_length, nb_filter, pool_length, lstm_output_size, batch_size,number_of_epochs, numclasses, test_size])
